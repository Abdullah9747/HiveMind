...
import 'package:reddit/features/community/screens/edit_communiy_screen.dart';
...
final loggedinRoute = RouteMap(routes: {
  ...
  "/edit-profile/:uid": (routeData) => MaterialPage(
        child: EditUserProfileScreen(uid: routeData.pathParameters['uid']!),
      ),
