...
final searhCommunityProvider = StreamProvider.family((ref, String query) {
...
class CommunityController extends StateNotifier<bool> {
  ...
  void createCommunity(String name, BuildContext context) async {
    ...
    res.fold((l) => showSnakBar(context, l.message), (r) {
      showSnakBar(context, 'Community created');
  ...
  void joinCommunity(Community community, BuildContext context) async {
    ...
    res.fold((l) => showSnakBar(context, l.message), (r) {
      if (community.members.contains(user.uid)) {
        showSnakBar(context, 'Community left sucessfully');
      } else {
        showSnakBar(context, 'Community Joined sucessfully');
      }
    });
  }
  ...
  void editCommunity(
    ...
    if (profileFile != null) {
      final res = await _storageRepository.storeFile(
          path: "comminities/profile", id: community.name, file: profileFile);
      res.fold(
    ...
    if (bannerFile != null) {
      final res = await _storageRepository.storeFile(
          path: "comminities/banner", id: community.name, file: bannerFile);
      res.fold(
        (l) => showSnakBar(context, l.message),
